...
public class DiaryPage
{
    ...
    @FindBy(how = How.XPATH, using = "(//*[@id='diary_recycler_view']//*[@id='more' and @class='android.widget.ImageButton'])[1]")
    public WebElement btn_containerBreakfast;
    @FindBy(how = How.XPATH, using = "(//*[@id='diary_recycler_view']//*[@id='more' and @class='android.widget.ImageButton'])[2]")
    public WebElement btn_containerLunch;
    @FindBy(how = How.XPATH, using = "(//*[@id='diary_recycler_view']//*[@id='more' and @class='android.widget.ImageButton'])[3]")
